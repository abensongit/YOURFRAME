...
CGFloat const kCFCTextViewPlaceholderVerticalMargin = 8.0; ///< placeholder垂直方向边距
CGFloat const kCFCTextViewPlaceholderHorizontalMargin = 6.0; ///< placeholder水平方向边距

@interface CFCTextView ()

@property (nonatomic, copy) CFCTextViewHandler changeHandler; ///< 文本改变Block
@property (nonatomic, copy) CFCTextViewHandler maxHandler; ///< 达到最大限制字符数Block
@property (nonatomic, strong) UILabel *placeholderLabel; ///< placeholderLabel

@end

@implementation CFCTextView
...
- (void)initialize
{
    ...
    [self addConstraint:[NSLayoutConstraint constraintWithItem:self.placeholderLabel
                                                     ...
                                                     attribute:NSLayoutAttributeTop
                                                    multiplier:1.0
                                                      constant:kCFCTextViewPlaceholderVerticalMargin]];
    [self addConstraint:[NSLayoutConstraint constraintWithItem:self.placeholderLabel
                                                     ...
                                                     attribute:NSLayoutAttributeLeft
                                                    multiplier:1.0
                                                      constant:kCFCTextViewPlaceholderHorizontalMargin]];
    [self addConstraint:[NSLayoutConstraint constraintWithItem:self.placeholderLabel
                                                     ...
                                                     attribute:NSLayoutAttributeWidth
                                                    multiplier:1.0
                                                      constant:-kCFCTextViewPlaceholderHorizontalMargin*2]];
    [self addConstraint:[NSLayoutConstraint constraintWithItem:self.placeholderLabel
                                                     ...
                                                     attribute:NSLayoutAttributeHeight
                                                    multiplier:1.0
                                                      constant:-kCFCTextViewPlaceholderVerticalMargin*2]];
}
...
- (void)addTextDidChangeHandler:(CFCTextViewHandler)changeHandler
{
    _changeHandler = [changeHandler copy];
}

- (void)addTextLengthDidMaxHandler:(CFCTextViewHandler)maxHandler
{
