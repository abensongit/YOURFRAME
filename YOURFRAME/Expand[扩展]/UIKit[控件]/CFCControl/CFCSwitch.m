...
- (void)layoutSubviews
{
    ...
    if (!self.isOn) {
        [self.knobView addBorderWithColor:self.tintColor cornerRadius:self.knobView.frame.size.height/2.0f andWidth:2.0f];
    } else {
        [self.knobView addBorderWithColor:self.onTintColor cornerRadius:self.knobView.frame.size.height/2.0f andWidth:2.0f];
    }
}
